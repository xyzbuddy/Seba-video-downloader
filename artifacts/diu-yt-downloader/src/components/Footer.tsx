    ...
    <footer className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 py-8 px-4">
      <div className="max-w-4xl mx-auto text-center space-y-4">
        ...
        <div className="flex items-center justify-center flex-wrap gap-x-4 gap-y-2 text-sm text-gray-500 dark:text-gray-400">
          ...
          <a
            href="https://www.linkedin.com/in/imxyzbuddy/"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 text-gray-600 dark:text-gray-300 hover:text-[#0A66C2] dark:hover:text-[#0A66C2] hover:underline underline-offset-2 transition-colors font-medium"
          >
            <LinkedInIcon />
            LinkedIn
          </a>
        ...
        <p className="text-xs text-gray-400 dark:text-gray-600">
          © 2025 Seba Downloader · All rights reserved · For personal use only · Respect content creators&apos; rights
        </p>
      </div>
    </footer>
  );
